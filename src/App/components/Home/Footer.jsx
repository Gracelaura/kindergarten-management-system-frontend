...
<div class=" border-solid bg-[#B124A3]">
<div class="">

  <div class="md:flex md:items-center">
    <div class="md:flex-1 md:px-4 text-center md:text-left">
      <p class="text-white">&copy; <strong>Copyright 2022</strong></p>
    </div>
    <div class="md:flex-1 md:px-4 text-center md:text-right">
      <a href="#" class="py-2 text-white inline-block hover:underline">Terms of Service</a>
