...
useEffect(() =>{},[
  axios.get(`http://localhost:3000/students/${id}`,config).then(data => setStudent(data))
])
  ...
  return (
    <div className='grid h-full col-span-1 w-full'>
      <div className='h-4/5 w-2/3 p-auto m-auto flex flex-col items-center justify-around'>
        ...
        <div>
          <input type="text" value={student.data.first_name}/>
        </div>
        <div>
          <input type="text" value={student.data.second_name}/>
        </div>
        <div>
          <input type="text" value={student.data.surname}/>
        </div>
        <div>
